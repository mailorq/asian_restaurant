...
- the relay refuses to publish an already-expired `pending` command and finalizes it locally as
  `rejected/command_expired` - safe precisely because it was never published;
