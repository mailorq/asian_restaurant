...
const PATHS: Record<string, string> = {
  ...
  eyeOff: "M2.06 12.35a1 1 0 0 1 0-.7 10.75 10.75 0 0 1 15.6-3.2M9.9 9.9a3 3 0 0 0 4.2 4.2M6.4 6.4a10.75 10.75 0 0 1 15.54 5.25 1 1 0 0 1 0 .7 10.75 10.75 0 0 1-4.34 5.25M4 4l16 16",
