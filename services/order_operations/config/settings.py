...
# no auth/sessions/contenttypes: operations owns no identity and shares no Django
# session store with storefront
...
# operations owns its own database; it never receives storefront DATABASE_URL
...
# JWT verification against Identity's public keys (wired in Phase 3; declared now)
